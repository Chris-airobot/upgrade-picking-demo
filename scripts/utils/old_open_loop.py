...
def robot_position_callback(msg: kortex_driver.msg.BaseFeedback):
    # Monitor robot position.
    global CURR_Z
    CURR_Z = msg.tool_pose_z
...
def execute_grasp():
    ...
    velo_pub = rospy.Publisher('/kinova_gen3_lite/in/cartesian_velocity', kortex_driver.msg.TwistCommand, queue_size=1)
    while MOVING and CURR_Z - 0.02 > gp_base.position.z:
        ...
        velo_pub.publish(kortex_driver.msg.TwistCommand(*vc))
        rospy.sleep(1/100.0)
...
if __name__ == '__main__':
    ...
    # Robot Monitors.
    # wrench_sub = rospy.Subscriber('/kinova_gen3_lite/out/tool_wrench', geometry_msgs.msg.WrenchStamped, robot_wrench_callback, queue_size=1)
    position_sub = rospy.Subscriber('/kinova_gen3_lite/base_feedback', kortex_driver.msg.BaseCyclic_Feedback, robot_position_callback, queue_size=1)
